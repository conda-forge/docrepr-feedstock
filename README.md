...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/docrepr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14711&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/docrepr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `docrepr` can be installed with:

```
conda install docrepr
```

It is possible to list all of the versions of `docrepr` available on your platform with:
